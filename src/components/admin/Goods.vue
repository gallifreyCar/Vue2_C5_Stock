...
<!--        搜索添加-->
          <el-col :span="10" >  <!--列宽-->
            <el-input placeholder="请输入内容"  v-model="queryInfo.query" clearable @click="getGoodList">
        ...
        <el-table :data="GoodList" border stripe>
          ...
          <el-table-column label="货物描述" prop="tdes"></el-table-column>
          ...
          <el-table-column label="操作" >
            <template slot-scope="scope">
              ...
              <el-button type="danger" icon="el-icon-delete" size="mini" @click= "deleteGood(scope.row.gno)"></el-button>
              </el-tooltip>
  ...
  methods:{
    ...
    async deleteGood(gno){
     const confirmResult =await this.$confirm("此操作将永久删除表单，是否继续？",'警告',{
      ...
      const{data:res}=await this.$http.post("deleteGood?gno="+gno);
      console.log(res);
      if(res!="success"){
        return this.$message.error("操作失败");
      }
